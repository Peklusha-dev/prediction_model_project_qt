...
class UiDepartmentWidget(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Выбор отдела"))
        self.label_chose_cust.setText(_translate("Form", "Выбор отдела"))
